...
import FormHeroSection from '@/app/components/FormsShard/FormHeroSection';
          ...
          <div className="flex max-lg:gap-12 flex-col justify-between h-full z-20 relative">
            ...
            <div>
              <ul className="flex flex-col gap-8 xl:gap-12">
                <li>
                  <span className="flex mb-3 items-center text-white text-sm font-normal gap-2"><Image width={30} height={30} src={phone} className="" alt="phone" /> 201016934955+</span>
                ...
                <li><span className="flex items-center text-white text-sm font-normal gap-3"><Image width={24} height={24} src={locationImg} className="" alt="" /> 
                {/* {t("footer-secUl-location")} */}
                </span></li>
              </ul>
            </div>
            <div className="flex gap-3">
              <a href="https://www.linkedin.com/company/ultrasoftsolutions" target="_blank"><Image width={30} height={30} src={linkedin} className="" alt="linkedin" /></a>
              <a href="https://www.facebook.com/UltraSoftERP" target="_blank"><Image width={30} height={30} src={facebook} className="" alt="facebook" /></a>
            </div>
          </div>
